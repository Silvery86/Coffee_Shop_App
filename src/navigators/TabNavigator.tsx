...
import FavortitesScreen from '../screens/FavortitesScreen'
...
const TabNavigator = () => {
  return (
   ...
   screenOptions={{ 
    ...
    <Tab.Screen name='Cart' component={CartScreen} options={{ tabBarIcon: ({focused,color,size}) => (
        <CustomIcon name='cart' size={25} color={
            focused ? COLORS.primaryOrangeHex : COLORS.primaryLightGreyHex
        }/>
     )}}></Tab.Screen>
    <Tab.Screen name='Favorite' component={FavortitesScreen} options={{ tabBarIcon: ({focused,color,size}) => (
